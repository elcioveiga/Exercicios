...
if (novoNome === "" ||valorDigitado === "") {
    mensagem.innerText = "Preencha o nome do projeto e os ponto."
    mensagem.style.color = "red"
    return;
}

if (quantidade <= 0) {
    mensagem.innerText = "Digite uma qunatidade maior que zero."
    mensagem.style.color = "red"
    return;
}
...
if (pontos >= LIMITE_PONTOS) {
    ...
    mensagem.innerText = "O limite de pontos foi atigindo";
